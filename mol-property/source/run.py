...
import torch
from models import Readout,bert_fc
...
def train():
    ...
    parser.add_argument("-bt","--bert_path", type = str, help='path of pretrained bert')
    ...
    trainer = Trainer(args, bert, model, train_dataloader=train_data_loader, test_dataloader=test_data_loader)
